...
jQuery(document).ready(function($){
	...
	jQuery(".color1").click(function(){
		jQuery("#colors").attr("href", "~/UserLayout/switcher/colors/teal.css");
	});
	
	jQuery(".color2").click(function(){
		jQuery("#colors").attr("href", "~/UserLayout/switcher/colors/blue.css");
	});
	
	jQuery(".color3").click(function(){
		jQuery("#colors").attr("href", "~/UserLayout/switcher/colors/maroon.css");
	});
	
	jQuery(".color4").click(function(){
		jQuery("#colors").attr("href", "~/UserLayout/switcher/colors/brown.css");
	});
	
	jQuery(".color5").click(function(){
		jQuery("#colors").attr("href", "~/UserLayout/switcher/colors/green.css");
	});
	
	jQuery(".color6").click(function(){
		jQuery("#colors").attr("href", "~/UserLayout/switcher/colors/dark_yellow.css");
	});
	
	jQuery(".color7").click(function(){
		jQuery("#colors").attr("href", "~/UserLayout/switcher/colors/yellow.css");
	});
